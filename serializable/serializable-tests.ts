...
// TypeScript are a pain. Instead just subclass it... but this only works in TypeScript 1.6+!
/*
...
class Pilot implements ISerializable {
	constructor(public name: string, public rank: string) {
	}
...
Serializable.includeInto(Pilot);
